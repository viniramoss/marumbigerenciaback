...
-- Dados iniciais serão inseridos manualmente via interface
-- Exemplo de insert para funcionários:
-- INSERT INTO funcionarios (nome, salario, loja) VALUES ('Nome', 0000.00, 'UN1');

-- Exemplo de insert para encargos:
